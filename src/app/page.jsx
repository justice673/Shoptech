      ...
      <div className={styles.main}>
        <div className={styles.main2}>
          <div className={styles.main2Left}>
            ...
            <p>
              {
                "At ShopTech, we bring you the latest and greatest in electronic gadgets, from cutting-edge smartphones and laptops to must-have accessories and home entertainment systems. Whether you&apos;re atech enthusiast or just looking for the perfect gift, explore ourextensive collection of premium products, all at unbeatableprices. Experience innovation at your fingertips and shop withconfidence today."
              }
            </p>
        ...
        <div className={styles.testimonial}>
          <div className={styles.container}>
            <div className={styles.testimonial1}>
              ...
              ></i>
              <p>
                Shoptech has completely changed the way I shop for electronics!
                The website is super easy to navigate, and I love how quickly I
                can find what I need. The product descriptions are detailed, and
                the customer service is excellent. I&apos;ve purchased multiple
                gaming accessories, and they always arrive on time. Highly
                recommend it to anyone who values quality and efficiency!
              </p>
              <div className={styles.rating}>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
            ...
            <div className={styles.testimonial1}>
              ...
              ></i>
              <p>
                Shoptech is hands down one of the best tech websites I&apos;ve
                come across. From the clean layout to the fast loading speeds,
                everything is just perfect. The product range is fantastic, and
                I love how easy it is to compare items before purchasing. Their
                customer support is quick to respond too! Can&apos;t imagine
                going anywhere else for my gaming gear
              </p>
              <div className={styles.rating}>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
            ...
            <div className={styles.testimonial1}>
              ...
              ></i>
              <p>
                I had an amazing experience shopping on Shoptech! The website is
                not only visually appealing, but it&apos;s also really
                intuitive. I was able to find my new PS5 controller in minutes,
                and the checkout process was seamless. Plus, the variety of
                products they offer is impressive! I&apos;ll definitely be
                coming back for more tech accessories
              </p>
              <div className={styles.rating}>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
